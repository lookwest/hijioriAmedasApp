...
# 最も遅い初雪日を取得
latest_first_snow = first_snow_df.loc[first_snow_df['sort_key'].idxmax()]

season = int(latest_first_snow['season_year'])
date = latest_first_snow['first_snow_date'].strftime('%Y年%m月%d日')

print(f"初雪が最も遅かったシーズン: {season}年〜{season+1}年")
