...
def plot_august_2025_max_temp():
    """
    CSVファイルを読み込み、2025年8月の日別の最高気温をグラフにして保存する。
    """
    try:
        ...
        target_year = 2025
        target_month = 8
        august_2025_data = df[(df['年月日'].dt.year == target_year) & (df['年月日'].dt.month == target_month)]
        ...
        # 日ごとのデータを取得
        days = august_2025_data['年月日'].dt.day
        max_temps = august_2025_data['最高気温(℃)']
