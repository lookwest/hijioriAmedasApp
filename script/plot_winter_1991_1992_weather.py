...
# 対象期間（1991年12月1日～1992年3月31日）のデータを抽出
...
# グラフのフォーマット設定
fig.suptitle('Weather Trend in Winter 1991-1992 (Hijiori)', fontsize=16)
...
# グラフを保存
plt.savefig('winter_1991_1992_weather.png')

print("グラフ 'winter_1991_1992_weather.png' を生成しました。")
