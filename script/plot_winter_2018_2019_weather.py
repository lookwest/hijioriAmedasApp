...
# 対象期間（2018年12月1日～2019年3月31日）のデータを抽出
...
# グラフのフォーマット設定
fig.suptitle('Weather Trend in Winter 2018-2019 (Hijiori)', fontsize=16)
...
# グラフを保存
plt.savefig('winter_2018_2019_weather.png')

print("グラフ 'winter_2018_2019_weather.png' を生成しました。")
